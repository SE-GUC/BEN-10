...
class PaTest extends AbstractTests {
  ...
  sentTaskOrientationInvitation() {
    ...
    test("send invitation for the members applying on that project", async done => {
      const response = await fetch(
        `${this.base_url}/${partnerid}/sendOrientationInvitations/${projectid}`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" }
        }
      );
      //console.lo("response to story 9" + response.status);
      const j = await response.json();
      //console.lo(j.msg);
      if (j.msg == "Task Orientations are sent successfully") {
        expect(response.status).toEqual(200);
      } else if (
        j.msg == "Project has already started" ||
        j.msg == "inavalid inputs" ||
        j.msg == "This project does not belong to you" ||
        j.msg == "Error occured"
      ) {
        expect(response.status).toEqual(404);
      } else expect(response.status).toEqual(400);
      done();
    });
  }
  ...
  cancelProject() {
    ...
    test("partner cancel un posted project", async done => {
      const response = await fetch(
        `${this.base_url}/${partnerid}/cancelproject/${projectid}`,
        {
          method: "DELETE",
          headers: { "Content-Type": "application/json" }
        }
      ...
      if (j.msg == "canceled and removed from array") {
        ...
        j.error == "you cannot cancel this project" ||
  ...
  postProjectFail() {
    ...
    test(`post ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c9cd0503c24d38b8731a/addProject`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  getMyProjectsFail() {
    ...
    test(`get ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c786899f8a26447d212f/myProjects`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  putApproveONFinalDraft() {
    ...
    test(`put ${this.base_url}`, async () => {
      ...
      ////console.lo(projid)
      const response = await fetch(
        `${this.base_url}/${parid}/myprojects/${projid}/finaldraft/approve`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putApproveONFinalDraftFail() {
    //enter invalid Projects id
    const requestBody = {};
    test(`put ${this.base_url}`, async () => {
      const par = await Partners.find();
      const par1 = par[0];
      ...
      const response = await fetch(
        `${
          this.base_url
        }/${parid}/myprojects/5c94436fc61339203ad8c7/finaldraft/approve`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  getMyProjects() {
    test(`get ${this.base_url}`, async () => {
      ...
      const response = await fetch(
        `${this.base_url}/${partid}/ShowFinalDraft`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  getMyProjectsFail() {
    test(`get ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c786899f8ab7d212f/ShowFinalDraft`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  putDisapproveONFinalDraft() {
    ...
    test(`put ${this.base_url}`, async () => {
      ...
      ////console.lo(parid)
      const response = await fetch(
        `${this.base_url}/${parid}/myprojects/${projid}/finaldraft/disapprove`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putDisapproveONFinalDraftFail() {
    //enter wrong Projects id
    const requestBody = {};
    test(`put ${this.base_url}`, async () => {
      const par = await Partners.find();
      const par1 = par[0];
      ...
      const response = await fetch(
        `${
          this.base_url
        }/${parid}/myprojects/5c94436fd0c339203ad8c7/finaldraft/disapprove`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  AssignCAtoProj() {
    ...
    test(`put ${this.base_url}`, async () => {
      ...
      for (k; k < projs.length; k++) {
        await fetch(`${this.projects_url}/${projs[k].id}/`, {
          method: "put",
      ...
      //////console.lo(proj)
      const response = await fetch(
        `${this.base_url}/${parid}/project/${proj}/AssignCAtoProject/${consul}`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  AssignCAtoProjFail() {
    //enter wrong id for consultancy agency
    const requestBody = {};
    test(`put ${this.base_url}`, async () => {
      const par = await Partners.find();
      const par1 = par[0];
      ...
      const response = await fetch(
        `${
          this.base_url
        }/${parid}/project/${projid}/AssignCAtoProject/5c7a6797938ccd1e08e7c`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  PartnerrequestratingbywrongPartnerID() {
    ...
    test(`post ${this.base_url}/:pid/rating/:eid/`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c786899f8a8e826447d212f/rating/5c9cda328acdd615d268e514/`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  PartnerrequestratingbynotavalidatedPartnerID() {
    ...
    test(`post ${this.base_url}/:pid/rating/:eid/`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c786899f8a8e26447d212f/rating/5c9cda328acdd615d268e514/`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  PartnerrequestratingbywrongEventID() {
    ...
    test(`post ${this.base_url}/:pid/rating/:eid/`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c786899f8a8e026447d212f/rating/5c9cda328acdd615d868e514/`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  PartnerrequestratingbynotavalidatedEventID() {
    ...
    test(`post ${this.base_url}/:pid/rating/:eid/`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c786899f8a8e026447d212f/rating/5c9cda328add615d268e514/`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  PartnerrequestratingbynotanEventsOwner() {
    ...
    test(`post ${this.base_url}/:pid/rating/:eid/`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c7a5ae73c28ff08583304ee/rating/5c9cda328add615d268e514/`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  acceptFinalReview() {
    ...
    test(`acceptFinalReview ${
      ...
      const response = await fetch(
        `${this.base_url}/${pr.companyID}/myprojects/${
          pr.id
        }/finalreview/approve`,
        {
          method: "put",
  ...
  deleteProject() {
    test(`delete ${this.base_url}`, async () => {
      ...
      const response = await fetch(
        `${this.base_url}/${result.data.companyID}/deleteProject/${
          result.data._id
        }`,
        {
          method: "DELETE",
  ...
  editProject() {
    test(`edit ${this.base_url}`, async () => {
      ...
      const result = await pr.json();
      const response = await fetch(
        `${this.base_url}/${result.data.companyID}/editProject/${
          result.data._id
        }`,
        {
          method: "put",
