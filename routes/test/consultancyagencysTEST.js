...
class CATest extends AbstractTests {
  ...
  deleteRequestFail() {
    test(`delete ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c79260b4328ab820437d835c23`,
        {
          method: "DELETE",
          headers: { "Content-Type": "application/json" }
        }
  ...
  viewMyEventsFail() {
    test(`CA view events fail ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c79260b4328a0437835cds/ShowMyEvents`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  putRequestApprove() {
    const requestBody = {};
    test(`put ${this.base_url}/${
      this.sharedState.id
    }/finalreview/:id2/approve/`, async () => {
      ...
      const response = await fetch(
        `${this.base_url}/${cid}/finalreview/${pr}/approve/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestApprovenotaFinalReviewProject() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab820437835c/finalreview/5c9541519e2e790b2bcbbf8e/approve/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestApprovebywrongCAID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79250b4328ab820437835c/finalreview/5c9541519e2e790b2bcbbf8e/approve/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestApprovebynotavalidatedCAID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab82037835c/finalreview/5c9541519e2e790b2bcbbf8e/approve/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestApprovebywrongProjectID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab820437835c/finalreview/5c9541519e2e720b2bcbbf8e/approve/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestApprovebynotavalidatedProjectID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab820437835c/finalreview/5c9541519e2e790b2bcbf8e/approve/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestApprovebynotaProjectsOwner() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c94ca61a090f53af42de4a6/finalreview/5c9cadf62ebb340f1324e458/approve/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestDisapprove() {
    ...
    test(`put ${this.base_url}/${
      this.sharedState.id
    }/finalreview/:id2/disapprove/`, async () => {
      const prs = await Projects.find();
      const cas = await CAs.find();
      var ids = [];
      var i = 0;
      ...
      if (cid != null && pr != null) {
        ...
        const response = await fetch(
          `${this.base_url}/${cid}/finalreview/${pr}/disapprove/`,
          {
            method: "PUT",
            body: JSON.stringify(requestBody),
            headers: { "Content-Type": "application/json" }
  ...
  putRequestDisapprovenotaFinalReviewProject() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab820437835c/finalreview/5c9541519e2e790b2bcbbf8e/disapprove/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestDisapprovebywrongCAID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79250b4328ab820437835c/finalreview/5c9541519e2e790b2bcbbf8e/disapprove/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestDisapprovebynotavalidatedCAID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab82037835c/finalreview/5c9541519e2e790b2bcbbf8e/disapprove/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestDisapprovebywrongProjectID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab820437835c/finalreview/5c9541519e2e720b2bcbbf8e/disapprove/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestDisapprovebynotavalidatedProjectID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab820437835c/finalreview/5c9541519e2e790b2bcbf8e/disapprove/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  putRequestDisapprovebynotaProjectsOwner() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c94ca61a090f53af42de4a6/finalreview/5c9cadf62ebb340f1324e458/disapprove/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  applyForProject() {
    test(`put ${this.base_url}`, async () => {
      ...
      const response = await fetch(
        `${this.base_url}/${con.id}/caApplyProject/${proj.id}`,
        {
          method: "PUT",
          //body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  applyForProjectFailed() {
    test(`put ${this.base_url}`, async () => {
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c79260b4328ab820437835/caApplyProject/5c94436fd0c61339203ad8`,
        {
          method: "PUT",
          //body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  viewMyProjectsFailed() {
    test(`get ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c79260b4328ab82043783c/projects`,
        {
          method: "GET",
          //body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  assignCandidate() {
    ...
    test(`assignCandidate ${
      ...
      const response = await fetch(
        `${this.base_url}/${ca}/myProjects/${app.projectId}/applyingMembers/${
          app.applicantId
        }/assign`,
        {
          method: "put",
  ...
  caRequestRating() {
    ...
    test(`caRequestRating ${this.base_url}/:id/rating/:eid`, async () => {
      ...
      const response = await fetch(`${this.base_url}/${cid}/rating/${eid}`, {
        method: "POST",
        body: JSON.stringify(requestBody),
        headers: { "Content-Type": "application/json" }
      });
  ...
  applyingMembers() {
    test(`applyingMembers ${
      ...
      const response = await fetch(
        `${this.base_url}/${ca}/myProjects/${prj.id}/applyingMembers`,
        {
          method: "get",
          headers: { "Content-Type": "application/json" }
        }
      ...
      const jsonResponse = await response.json();
      //console.lo("hhhhhhhhhhhhhhhhhhhhhhhhhhh");
      //console.lo(jsonResponse);
  ...
  applyingMembersFail() {
    test(`applyingMembersFail ${
      ...
      const response = await fetch(
        `${this.base_url}/${
          project.consultancyID
        }/myProjects/5c9446ec609f7c5080979fd/applyingMembers`,
        {
          method: "get",
          headers: { "Content-Type": "application/json" }
        }
  ...
  assignCandidateFail() {
    ...
    test(`assignCandidateFail ${
      ...
      projs = projs.filter(
        p =>
          p.applyingCA.length != null &&
          p.consultancyID != null &&
          p &&
          p.applyingCA.length > 0
      );
      const project = projs[0];

      const response = await fetch(
        `${this.base_url}/${project.consultancyID}/myProjects/${
          project.id
        }/applyingMembers/5c9446ec609f7c5080979fdb/assign`,
        {
          method: "put",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  DecideProject() {
    test(`approve a project = > put ${this.base_url}`, async done => {
      ...
      const flag = true;
      //console.lo(caid);
      //console.lo(project.id);
      // //console.lo(project.id)
      // //console.lo(project.companyID)
      var requestBody = {};
      //console.lo(`${this.base_url}/${caid}/decide/${project.id}/${flag}`);
      const response = await fetch(
        `${this.base_url}/${caid}/decide/${project.id}/${flag}`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  caRequestRatingFail() {
    ...
    test(`caRequestRatingFail ${this.base_url}/:id/rating/:eid`, async () => {
      const events = await Events.find();
      const cas = await CAs.find();
      var ids = [];
      var i = 0;
      ...
      const response = await fetch(
        `${this.base_url}/${cid}/rating/5c9446ec609f7c5080979fdb`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
