...
class MTest extends AbstractTests {
  ...
  submitTaskIDmistach() {
    test("testing an id mismtach", async () => {
      ...
      const response = await fetch(
        `${
          this.base_url
        }/${member_id}/Myprojects/${project_id}/submit/www.projectlzink.com`,
        {
          method: "PUT",
  ...
  submitTaskProjectDoesntExist() {
    test("testing for a project that doesn't exist", async () => {
      ...
      const requestBody = {};
      const response = await fetch(
        `${this.base_url}/${mid}/Myprojects/${pid}/submit/www.projectlzink.com`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  submitTaskLifeCycleNotInProgress() {
    test("test for a life cycle other than In Progress", async () => {
      ...
      if (index != null) {
        ...
        //console.lo("sorry no matching in the db");
      }
    });
  }
        ...
        if (Object.keys(jsonResponse1).toString() != "error") {
          if (member_id2 != null) {
            ...
            const response = await fetch(
              `${
                this.base_url
              }/${member_id2}/Myprojects/${project_id}/submit/www.projectlzink.com`,
              {
                method: "PUT",
                body: JSON.stringify(requestBody),
                headers: { "Content-Type": "application/json" }
          ...
          //console.lo("there is no such project");
        }
      } else {
        //console.lo("it didnt update a project :(");
      }
  ...
  getmyNotificationsIdMistmatch() {
    test("testing for notifications viewing id mismatch", async () => {
      const member_id = 1;
      const response = await fetch(
        `${this.base_url}/${member_id}/notifications`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  getmyNotificationsNoSuchMember() {
    test("testing for notification for an id that is not a member id", async () => {
      ...
      if (admin_id != null) {
        const response = await fetch(
          `${this.base_url}/${admin_id}/notifications`,
          {
            method: "GET",
            headers: { "Content-Type": "application/json" }
          }
  ...
  viewTaskInvitationIdMisMatch() {
    test("testing for task orientation viewing id mismatch", async () => {
      const member_id = 1;
      const response = await fetch(
        `${this.base_url}/${member_id}/task_orientation`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  viewTaskInvitationNoSuchMember() {
    test("testing for task orientation for an id that is not a member id", async () => {
      ...
      if (admin_id != null) {
        const response = await fetch(
          `${this.base_url}/${admin_id}/task_orientation`,
          {
            method: "GET",
            headers: { "Content-Type": "application/json" }
          }
  ...
  submitTask() {
    test("submitting a task to be finally reviewed", async () => {
      ...
      if (project_id != null && member_id != null) {
        ...
        //console.lo("there is no matching in the db:(");
      }
    });
  }
  ...
  viewTaskInvitation() {
    test("view task orientation invitations", async () => {
      ...
      if (notified_member != null) {
        const response = await fetch(
          `${this.base_url}/${notified_member}/task_orientation`,
          {
            method: "GET",
            headers: { "Content-Type": "application/json" }
          }
  ...
  appylyForprojectIdMismatch() {
    test("apply for a project with id mismatch", async () => {
      ...
      const response = await fetch(
        `${this.base_url}/${member_id}/projects/${project_id}/apply`,
        {
          method: "POST",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  appylyForprojectWithNoSuchMember() {
    test("testing for a member that is not a member :)", async () => {
      ...
      if (admin_id != null && project_id != null) {
        ...
        const response = await fetch(
          `${this.base_url}/${admin_id}/projects/${project_id}/apply`,
          {
            method: "POST",
            body: JSON.stringify(requestBody),
            headers: { "Content-Type": "application/json" }
  ...
  getmyNotifications() {
    test("view notifications", async () => {
      ...
      if (notified_member != null) {
        const response = await fetch(
          `${this.base_url}/${notified_member}/notifications`,
          {
            method: "GET",
            headers: { "Content-Type": "application/json" }
          }
  ...
  postRequest() {
    ...
    test(`post ${this.base_url}`, async done => {
      ...
      //console.lo("response stastus method 1 post: " + response.status);
  ...
  postRequestBadRequest() {
    ...
    test(`post ${this.base_url}`, async done => {
      ...
      //console.lo("response stastus method 2 post bad: " + response.status);
      const jsonr = response.json();
      //console.lo(jsonr);
  ...
  getRequest() {
    test(`get ${this.base_url}`, async done => {
      ...
      //console.lo("response stastus method 3 get: " + response.status);
      expect(response.status).toEqual(200);
      done();
    });
  }
  ...
  getRequestbyId() {
    test(`get ${this.base_url}/${this.sharedState.id}`, async done => {
      ...
      //console.lo("response stastus method 4 get by id: " + response.status);
      expect(response.status).toEqual(200);
      done();
    });
  }
  putRequest() {
    ...
    test(`put ${this.base_url}/${this.sharedState.id}`, async done => {
      ...
      //console.lo("response stastus method 5 put: " + response.status);
      expect(response.status).toEqual(200);
      done();
    });
  }
  deleteRequest() {
    test(`delete ${this.base_url}/${this.sharedState.id}`, async done => {
      ...
      //console.lo("response stastus method 6 delete : " + response.status);
      expect(response.status).toEqual(200);
      done();
    });
  }
  ...
  getProjectsFail() {
    test(`get ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c9e5750086c7f40c08183/getProject`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  getEventsFail() {
    test(`get ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c9e5750086c7f40c08183/getEvent`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  getMyProjectsFail() {
    test(`get ${this.base_url}`, async () => {
      const response = await fetch(
        `${this.base_url}/5c9e5750086c7f40c08183/ShowMyProjects`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  posteventbywrongMemberID() {
    ...
    test(`put ${this.base_url}/:id1/events/:id2/`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c93d983f3fe6358b41cd7a/events/5c9ce0e20ddd11042a301e26/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  bookEvent() {
    test(`put ${this.base_url}`, async () => {
      ...
      const evid = ev1.id;
      const response = await fetch(
        `${this.base_url}/${memid}/bookEvent/${evid}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" }
        }
  ...
  bookEventFail() {
    test(`put ${this.base_url}`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c9e5514086c0c08183d8/bookEvent/5c93e86e61fb9b030dc8e`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" }
        }
  ...
  posteventbynotavalidatedMemberID() {
    ...
    test(`put ${this.base_url}/"id1"/events/:id2/`, async () => {
      const response = await fetch(
        `${
          this.base_url
        }/5c93d983f3fe7358b41ccd7a/events/5c9ce0e20ddd11042a301e26/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  posteventbywrongEventID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c93d983f3fe6358b41ccd7a/events/5c9ce0e20dd11042a301e26/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
  ...
  matchSkillSetWithProjects() {
    test(`post ${this.base_url}/memberID/recommendations`, async () => {
      ...
      const response = await fetch(
        `${this.base_url}/${myMember._id}/recommendations`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" }
        }
  ...
  posteventbynotavalidatedEventID() {
    ...
    test(`put ${this.base_url}/${
      ...
      const response = await fetch(
        `${
          this.base_url
        }/5c93d983f3fe6358b41ccd7a/events/5c9ce0e27ddd11042a301e26/`,
        {
          method: "PUT",
          body: JSON.stringify(requestBody),
          headers: { "Content-Type": "application/json" }
